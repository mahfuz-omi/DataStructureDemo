...
public class GraphAdjacencyMatrixDirected {   //Directed graph
    ...
    public GraphAdjacencyMatrixDirected(int numOfVertices)
    {
        ...
        for(int i=0;i<numOfVertices;i++)
        {
            ...
            {
                if(i == j)
                    this.edgesArray[i][j] = 0;
                else
                    this.edgesArray[i][j] = 1000; /// initially store that value...or -1
            }
        }
    }
    ...
    public void addEdge_weighted(int weight,Vertex from,Vertex to)
    {
        int fromPosition = 0,toPosition = 0;
        for(int i=0;i<this.vertices.length;i++)
        {
        ...
        this.edgesArray[fromPosition][toPosition] = weight;
    }
    
    
    
    public void addEdge_weighted(int weight,String from,String to)
    {
        int fromPosition = 0,toPosition = 0;
        for(int i=0;i<this.vertices.length;i++)
        {
